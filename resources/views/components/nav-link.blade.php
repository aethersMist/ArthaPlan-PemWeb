...
$classes = ($active ?? false)
            ? 'flex items-center justify-center px-4 py-2 text-light bg-accent rounded-lg hover:bg-primary focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
